...
class ExcMultiPattern(MultiPattern):
    ...
    def __build_tree(pats, outerbits, outermask):
        ...
        for i in pats:
            ...
            # print("{}:{:08x},{:08x}".format(i.name, i.fixedmask, i.fixedbits))
        ...
        # print("{:#08x},{:#08x}".format(fullmask, innermask))
    ...
    def build_tree(self):
        ...
        if insnwidth == 32:
            for i in self.pats:
                print('    {'+'{:>15s},{:>22s}, {}, {}, COUNT_INDIVIDUAL'.format(
                    '"%s"'%i.base.name,
                    '"%s"'%i.name,
                    '%#.8x'%i.fixedmask,
                    '%#.8x'%i.fixedbits
